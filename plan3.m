...
%
    ...
    [~,dydt(2)] = Proportional_Guidance(y(3,i), y(4,i), x_t, y_t, y(1,i), 0, y(2,i), 0, K);
    y(2,1)= y(2,1) + dydt(2);
    while(y(4,i)>0 && sqrt((y(3,i)-x_t)^2+(y(4,i)-y_t)^2)>1 && y(1,i)>0)
        ...
        [q1,dydt(2)] = Proportional_Guidance(y(3,i), y(4,i), x_t, y_t, y(1,i), 0, y(2,i), 0, K);%theta 
        dydt(3) = y(1,i) * cos(y(2,i)); % dx/dt
        dydt(4) = y(1,i) * sin(y(2,i)); % dy/dt
        y(6,i+1)=deg2rad((y(8,i) * y(1,i) * dydt(2)+y(8,i) * g * cos(y(2,i)))/(0.25 * q1 *S_ref))-0.05 * y(5,i);%alpha
